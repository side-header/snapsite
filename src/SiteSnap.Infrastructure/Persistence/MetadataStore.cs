...
namespace SiteSnap.Infrastructure.Persistence;

public sealed class MetadataStore : IMetadataStore
{
    public const string MetadataFileName = WorkspaceMetadata.FileName;
    ...
    string IMetadataStore.MetadataPath(string rootDir) => MetadataPath(rootDir);
