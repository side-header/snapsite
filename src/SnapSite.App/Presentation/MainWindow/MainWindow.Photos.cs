...
public sealed partial class MainWindow
{
        ...
        double collectionWidth)
    {
        ...
        var image = new Image
        {
            ...
            Source = thumbnailService.TryGetCached(WorkspacePath.ToAbsolutePath(state.RootDir, relativePath))
        };
    ...
    private void ShowPhotoPathInStatus(string relativePath)
    {
        ...
        status.Text = WorkspacePath.ToAbsolutePath(state.RootDir, relativePath);
    }
    ...
    private void RenamePath(string relativePath, string newName)
    {
        ...
        try
        {
            ...
            var targetPath = WorkspacePath.ToAbsolutePath(state.RootDir, newRelativePath);
